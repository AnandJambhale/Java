...
public class Main {
    ...
    public void setEntities(Entities entities){
        this.countryCode = entities.getCountryCode();
        this.countryName = entities.getCountryName();
        this.countryCodeMachine = entities.getCountryCodeMachine();
        this.countryCodeAlternate = entities.getCountryCodeAlternate();
        this.regionCode = entities.getRegionCode();
        this.overallLimit = entities.getOverallLimit();
        Lban = entities.getLban();
        this.sEuMember = entities.getsEuMember();
        BicCode = entities.getBicCode();
        MtGenerate = entities.getMtGenerate();
        this.isClearingNetwork = entities.isClearingNetwork();
        this.status = entities.getStatus();
        this.recordVersion = entities.getRecordVersion();
        this.authorized = entities.isAuthorized();
        this.lastConfigurationAction = entities.getLastConfigurationAction();
        this.lifeCycleId = entities.getLifeCycleId();
        this.referenceNo = entities.getReferenceNo();
    }
    public void setAudit(Audit audit){
        this.countryCode = audit.getCountryCode();
        this.countryName = audit.getCountryName();
        this.countryCodeMachine = audit.getCountryCodeMachine();
        this.countryCodeAlternate = audit.getCountryCodeAlternate();
        this.regionCode = audit.getRegionCode();
        this.overallLimit = audit.getOverallLimit();
        Lban = audit.getLban();
        this.sEuMember = audit.getsEuMember();
        BicCode = audit.getBicCode();
        MtGenerate = audit.getMtGenerate();
        this.isClearingNetwork = audit.isClearingNetwork();
        this.status = audit.getStatus();
        this.recordVersion = audit.getRecordVersion();
        this.authorized = audit.isAuthorized();
        this.lastConfigurationAction = audit.getLastConfigurationAction();
        this.lifeCycleId = audit.getLifeCycleId();
        this.referenceNo = audit.getReferenceNo();
    }
}
